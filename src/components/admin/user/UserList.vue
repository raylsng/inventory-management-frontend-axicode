...
export default {
    ...
    data() {
        return {
            users: [
                { id: 1, name: "Amanda", email: "Amanda@example.com", role: "Admin" },
                { id: 2, name: "Risqi", email: "Risqi@example.com", role: "Admin" },
                { id: 2, name: "Novi", email: "Amanda@example.com", role: "Admin" },
                { id: 3, name: "Raynaldi", email: "Ray@example.com", role: "user" },
                { id: 2, name: "Fikri", email: "Fikri@example.com", role: "User" }
            ],
            showForm: false,
            selectedUser: null,
            isEdit: false,
